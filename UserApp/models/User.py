...
from django.core.validators import EmailValidator, validate_email, MinValueValidator, \
...
# from django.contrib.auth.hashers import make_password
# from django_react_base.settings import EMAIL_HOST_USER
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    Building_name_And_RoomNumber = models.TextField(null=True, blank=True)
    # Todo: make this a Charfield with 400 length
    ...
    Affliated_Department = models.ForeignKey(Department, on_delete=models.CASCADE, null=True)
