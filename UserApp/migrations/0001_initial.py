    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PostalCode', models.IntegerField(blank=True, null=True, validators=[django.core.validators.RegexValidator(code='invalid_username', message='Username must be Alphanumeric', regex='^[1-9]{1}[0-9]{2}\\s{0, 1}[0-9]{3}$')])),
                ('Building_name_And_RoomNumber', models.TextField(blank=True, null=True)),
                ('Student_phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None)),
                ...
                ('collage_passingYear', models.DateField(blank=True, null=True)),
                ...
                ('Affliated_Department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Department.department')),
